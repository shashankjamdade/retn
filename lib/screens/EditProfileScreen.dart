...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void didChangeDependencies() {
    ...
    var userSelectedLocation = StateContainer.of(context).mUserLocationSelected;
    if (userSelectedLocation != null) {
      if (widget.mUserprofileRes.data.address != null) {
        ...
        userLocation = StateContainer.of(context).mUserLocationSelected != null
            ? "${StateContainer.of(context).mUserLocationSelected.address}, ${StateContainer.of(context).mUserLocationSelected.city}, ${StateContainer.of(context).mUserLocationSelected.state}"
            : "";
      }
