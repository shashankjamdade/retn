...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void storeResInPrefs(BuildContext context, LoginResponse res) async{
    ...
    debugPrint("PREFS_STORED_LOGIN-----> ${res.status}");
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextInputWidget(mobileEmailController, "Mobile no / Email ID", false, (String value) {
                          if (value.isEmpty) {
                            return "Please enter valid email/mobile";
                          }
                        }, TextInputType.emailAddress),
                        SizedBox(height: getProportionateScreenHeight(context, space_20),),
                        BtnTextInputWidget(passwordController, "Password", "Login", true, (){
...
//      authenticationBloc.dispatch(LoginEvent(loginInfoModel: testLogin));
                            authenticationBloc..add(LoginReqAuthenticationEvent(emailOrMobile: mobileEmailController.text.trim(), password: passwordController.text.trim()));
...
//                              ..add(LoginReqAuthenticationEvent(emailOrMobile: mobileEmailController.text.trim(), password: passwordController.text.trim()));
                        ...
                        SizedBox(height: getProportionateScreenHeight(context, space_20),),
                        Text("OR", style: CommonStyles.getRalewayStyle(space_18, FontWeight.w600, CommonStyles.primaryColor),),
                        SizedBox(height: getProportionateScreenHeight(context, space_20),),
                        Row(
