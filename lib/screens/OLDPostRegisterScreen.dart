...
class OLDPostRegisterScreen extends StatefulWidget {
  String name;
  String email;

  OLDPostRegisterScreen(this.name, this.email);

  @override
  _OLDPostRegisterScreenState createState() => _OLDPostRegisterScreenState();
}

class _OLDPostRegisterScreenState extends State<OLDPostRegisterScreen> {
