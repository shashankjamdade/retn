...
const String empty_email = "Please enter valid email ID";
...
const String PERMISSION_CONSENT_SUBMSG = "We strongly believe in user's privacy that's why we never collect user's private data in our panel except what has been provided by them and we respect user's privacy.";
